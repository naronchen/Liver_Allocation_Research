...
DeterministicMaxFlow::DeterministicMaxFlow(vector<SurgeryCenter*> surgeryCenters, vector<Hospital*> hospitals, map<Hospital*, vector<SurgeryCenter*>*> mappings) :Algorithm(surgeryCenters,hospitals, mappings, "DeterministicMaxFlow"){
    int total = 0;
...
int DeterministicMaxFlow::flipCoin(vector<double> p){
...
void DeterministicMaxFlow::processDonation(Event* e){
